...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = "INSERT INTO ticket (id, resident_id, category, sub_category, reason_for_inquiry) 
                     VALUES (?, ?, ?, ?, ?)";
    $insert_stmt = $conn->prepare($insert_query);
    $insert_stmt->bind_param("issss", $user_id, $resident_id, $category, $sub_category, $reason_for_inquiry);
...
$fetch_tickets_query = "SELECT id, category, sub_category, reason_for_inquiry 
